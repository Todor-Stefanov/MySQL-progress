...
SELECT (CASE WHEN `middle_name` IS NULL THEN concat_ws(' ', `first_name`, `last_name`)
             ELSE concat_ws(' ', `first_name`,`middle_name`, `last_name`) END)
