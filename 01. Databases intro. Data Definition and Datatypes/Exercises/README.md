...
-	directors (id, director_name, notes) - director_name cannot be null
-	genres (id, genre_name, notes) - genre_name cannot be null
-	categories (id, category_name, notes) - category_name cannot be null
-	movies (id, title, director_id, copyright_year, length, genre_id, category_id, rating, notes) -title cannot be null  
